...
<head>
    ...
    <link rel="stylesheet" href="team/css/team.css">
        ...
        <div class="container">
            <div class="center wow fadeInDown">
                <div class="text-center pb-1 border-primary mb-4">
                    <h2 class="text-primary">Current Team</h2>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="filters-content">
                    ...
                    <div class="row portfolio-grid justify-content-center">
                        ...
                        <div class="col-lg-3 col-md-4 all Sanket Nontech">
                            <div class="our-team">
                                <div class="pic">
                                ...
                                <ul class="social">
                                    ...
                                    <li><a href="https://laddhashreya2000.github.io/" class="fa fa-link" target="_blank"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 all HRC">
                        ...
                        <div class="col-lg-3 col-md-4 all STADS">
                            <div class="our-team">
                                ...
                                <ul class="social">
                                    ...
                                    <li><a href="https://aravindbharathi.github.io/" class="fa fa-link" target="_blank"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 all Sanket">
                        ...
                        <div class="col-lg-3 col-md-4 all RVD">
                            <div class="our-team">
                                ...
                                <ul class="social">
                                    ...
                                    <li><a href="http://home.iitb.ac.in/~tiwari.dhananjay/" class="fa fa-link" target="_blank"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 all STADS">
    ...
    <div class="all subsystem-heading">
        <h4>Mechanical Subsystem</h4>
                        ...
                        <div class="col-lg-3 col-md-4 all Sanket">
                            <div class="our-team">
                                <div class="pic">
                                    <img src="images/team/Ashay_Wakode.jpg" alt="" />
                                </div>
                                <div class="team-content">
                                    <h3 class="title">
                        ...
                        <div class="col-lg-3 col-md-4 all Sanket">
                            <div class="our-team">
                                ...
                                <ul class="social">
                                    ...
                                    <!--<li><a href="#" class="fa fa-link" target="_blank"></a></li>-->
                                    <li><a href="https://navjitdebnath.blogspot.com/" class="fa fa-blogger-b" target="_blank"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 all Sanket">
